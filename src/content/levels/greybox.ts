...
export const greybox: LevelDef = {
  ...
  // Pickups are entities, not grid glyphs: one concept, one home. The Core sits
  // inside the pool, so the water tile under it survives being collected.
  entities: [
    { type: 'inkCore', x: 102, y: 10 },
    { type: 'inkBulb', x: 30, y: 13 },
  ],
}
